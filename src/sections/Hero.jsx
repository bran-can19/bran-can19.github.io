  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
          ...
          <div className="space-y-8">
            <div className="animate-fade-in">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-primary">
                ...
                Desarrollador Full Stack • Especialista Web y Móvil
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hola, soy Brandon — un desarrollador de software especializado en construir
                aplicaciones web y móviles escalables y eficientes que los usuarios disfrutan.
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/bran-can19" },
                { icon: Linkedin, href: "#" },
                { icon: Twitter, href: "#" },
              ].map((social, idx) => (
                <a
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-fade-in animation-delay-800">
        ...
        >
          <span className="text-xs uppercase tracking-wider">Deslizar</span>
